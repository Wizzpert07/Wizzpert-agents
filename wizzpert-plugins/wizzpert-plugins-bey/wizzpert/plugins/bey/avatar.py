...
class AvatarSession:
    ...
    async def start(
        ...
        *,
        ...
        await self._start_agent(wizzpert_url, wizzpert_token)
    ...
    async def _start_agent(self, wizzpert_url: str, wizzpert_token: str) -> None:
            ...
            try:
                async with self._ensure_http_session().post(
                    ...
                    json={
                        ...
                        "wizzpert_url": wizzpert_url,
                        "wizzpert_token": wizzpert_token,
                    },
