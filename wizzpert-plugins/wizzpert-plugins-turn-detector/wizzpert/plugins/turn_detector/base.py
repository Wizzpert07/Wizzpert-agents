...
from wizzpert.agents.inference_runner import _InferenceRunner
from wizzpert.agents.ipc.inference_executor import InferenceExecutor
...
class _EUORunnerBase(_InferenceRunner):
    ...
    def initialize(self) -> None:
        ...
        try:
            ...
            raise RuntimeError(
                "wizzpert-plugins-turn-detector initialization failed. "
                f"Could not find model {HG_MODEL} with revision {self._model_revision}."
            ) from None
