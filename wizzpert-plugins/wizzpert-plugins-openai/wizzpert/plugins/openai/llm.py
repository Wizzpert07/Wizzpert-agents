...
import openai
from wizzpert.agents import APIConnectionError, APIStatusError, APITimeoutError, llm
from wizzpert.agents.llm import ToolChoice, utils as llm_utils
from wizzpert.agents.llm.chat_context import ChatContext
from wizzpert.agents.llm.tool_context import FunctionTool
...
class LLMStream(llm.LLMStream):
    ...
    def _parse_choice(self, id: str, choice: Choice) -> llm.ChatChunk | None:
        ...
        # https://github.com/wizzpert/agents/issues/688
