...
class JobContext:
    ...
    def api(self) -> api.wizzpertAPI:
        return api.wizzpertAPI(session=http_context.http_session())
    ...
    def add_sip_participant(
        ...
        *,
        ...
        Make sure you have an outbound SIP trunk created in wizzpert.
        See https://docs.wizzpert.io/sip/trunk-outbound/ for more information.
        """
        task = asyncio.create_task(
    ...
    def transfer_sip_participant(
        ...
        See https://docs.wizzpert.io/sip/transfer-cold/ for more information.
        """
...
class JobRequest:
    ...
    async def accept(
        ...
        *,
        ...
        """Accept the job request, and start the job if the wizzpert SFU assigns the job to our worker."""  # noqa: E501
        if not identity:
