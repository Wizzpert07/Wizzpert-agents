...
class FunctionTool(Protocol):
    __wizzpert_tool_info: _FunctionToolInfo
...
class RawFunctionTool(Protocol):
    __wizzpert_raw_tool_info: _RawFunctionToolInfo
    ...
    *,
    ...
    def deco(func: F | Raw_F) -> RawFunctionTool | FunctionTool:
        if raw_schema is not None:
            ...
            setattr(func, "__wizzpert_raw_tool_info", info)
            ...
            setattr(func, "__wizzpert_tool_info", info)
