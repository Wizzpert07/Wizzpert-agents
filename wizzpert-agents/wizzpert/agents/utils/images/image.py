...
def import_pil():
    try:
        ...
        raise ImportError(
            "You haven't included the 'images' optional dependencies. Please install the 'codecs' extra by running `pip install wizzpert-agents[images]`"  # noqa: E501
        ) from None
