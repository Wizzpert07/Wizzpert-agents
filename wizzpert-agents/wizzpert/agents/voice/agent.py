...
def _authorize_inline_task(
    ...
    setattr(task, "__wizzpert_agents_inline_task", _InlineTaskInfo(function_call=function_call))


def _get_inline_task_info(task: asyncio.Task) -> _InlineTaskInfo | None:
    return getattr(task, "__wizzpert_agents_inline_task", None)


def _is_inline_task_authorized(task: asyncio.Task) -> bool:
    return getattr(task, "__wizzpert_agents_inline_task", None) is not None
