...
class BuiltinAudioClip(enum.Enum):
    ...
    def path(self) -> str:
        file_path = files("wizzpert.agents.resources") / self.value
...
class BackgroundAudioPlayer:
    def __init__(
        ...
        *,
        ...
        This component creates and publishes a continuous audio track to a wizzpert room while managing
    ...
    async def start(
        ...
        *,
        ...
        Args:
            room (rtc.Room):
                The wizzpert Room object where the audio track will be published.
