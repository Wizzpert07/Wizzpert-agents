...
def run_app(
    ...
    *,
    ...
    @click.option(
        "--url",
        envvar="wizzpert_URL",
        help="wizzpert server or Cloud project's websocket URL",
    )
    @click.option(
        "--api-key",
        envvar="wizzpert_API_KEY",
        help="wizzpert server or Cloud project's API key",
    )
    @click.option(
        "--api-secret",
        envvar="wizzpert_API_SECRET",
        help="wizzpert server or Cloud project's API secret",
    )
    @click.option(
        "--drain-timeout",
        type=int,
