...
from wizzpert.agents import Agent, AgentSession, JobContext, JobProcess, WorkerOptions, cli
...
## This example demonstrates how to use wizzpert's turn detection model with a realtime LLM.
...
async def entrypoint(ctx: JobContext):
    ...
    session = AgentSession(
        ...
        llm=openai.realtime.RealtimeModel(
            ...
            # wizzpert's turn detection model
            turn_detection=None,
